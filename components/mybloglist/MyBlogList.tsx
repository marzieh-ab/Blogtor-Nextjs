...
const MyBlogList=()=> {
    ...
    const deleteArticle=(blogId:string)=>{
        ...
        <div className="mt-5  flex   justify-between items-center flex-wrap p-4">
           ...
           blogs.map((item)=>{
             return (
              ...
              <div    className=" w-[100%] md:w-[30%]   lg:w-[45%]  mt-4 h-[300px] border-[1px] border-[#ccc] ">
                ...
                <Link   href={`myblogs/${item._id}`} className="p-1 w-[70px] bg-[green]  text-[#fff]   flex justify-center  rounded-md  text-center mx-4">
                  <MdOutlineEdit/>
                  </Link>
