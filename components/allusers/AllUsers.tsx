...
import { writers as allwriters } from '../../pages/alluser/index'
...
const  AllUsers:FC<allwriters >=({data})=> {
    console.log(data)
      ...
      <div>
        ...
        <div >
          ...
          {data.map((user)=>{
              ...
              <Link  href={`/alluser/${user._id}`} className="  
         ...
         md:flex md:flex-row md:items-center  md:justify-between md:flex-wrap md:px-3  md:w-[30%] 
              ...
              border-[1px] rounded-md   md:my-4   sm:space-y-4     ">
                              <div className="     md:flex md:items-center  md:justify-center mx-auto " >
                                <img src={user.avatar} alt="" className="  border-[1px]  w-[200px] h-[200px]  rounded-[50%] mt-3   "    onError={imageOnErrorHandler  }/>
                              </div>
